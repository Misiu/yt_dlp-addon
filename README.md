...
Version 0.1.2 is marked **experimental** until its Ingress, AppArmor, backup, download, and update paths have been verified on a real Home Assistant OS test instance.
