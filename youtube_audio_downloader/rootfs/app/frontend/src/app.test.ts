...
function mockApi(): void {
  api.request.mockImplementation((path: string, options?: RequestInit) => {
    ...
    if (path === "v1/info") return Promise.resolve({ version: "0.1.0", yt_dlp_version: "2026.7.4", ffmpeg_version: "installed", architecture: "amd64", output_directory: "youtube_audio", database: "/data/youtube_audio.db", queue_limit: 100 });
